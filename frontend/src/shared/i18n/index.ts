...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, string>, {
  ...
  bindEgressNode: "代理节点", bindEgressNodes: "代理节点（可多选）", bindEgressSelected: "已选 {{count}} 个节点", bindEgressPerNode: "每个节点绑定账号数", bindEgressAuto: "自动建议每个节点 {{count}} 个；可按需调整。", bindEgressMax: "最大 {{count}} 个", bindEgressEmpty: "请选择代理节点", bindEgressNoNodes: "当前账号池没有可绑定的代理节点", bindEgressNoCapacity: "所选节点没有可用绑定容量", egressBound: "代理已绑定", egressBoundPartial: "代理部分绑定完成：已绑定 {{assigned}} 个，未绑定 {{unassigned}} 个", egressUnbound: "代理已解绑", egressFilter: "代理绑定",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  ...
  bindEgressNode: "Proxy node", bindEgressNodes: "Proxy nodes (multi-select)", bindEgressSelected: "{{count}} nodes selected", bindEgressPerNode: "Accounts per node", bindEgressAuto: "Automatic suggestion: {{count}} per node; adjust as needed.", bindEgressMax: "Maximum {{count}}", bindEgressEmpty: "Select proxy nodes", bindEgressNoNodes: "No compatible proxy nodes are available for this account pool", bindEgressNoCapacity: "The selected nodes have no remaining binding capacity", egressBound: "Proxy bound", egressBoundPartial: "Proxy binding partially completed: {{assigned}} assigned, {{unassigned}} unassigned", egressUnbound: "Proxy unbound", egressFilter: "Proxy binding",
